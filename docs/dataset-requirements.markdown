...
<!-- * &ldquo;OTDI&rdquo; for additional fields derived from the [Data Provenance Standard](https://dataandtrustalliance.org/work/data-provenance-standards) (OTDI). Where we require OTDI fields, add them to the `README.md` they seem to fit best. -->
